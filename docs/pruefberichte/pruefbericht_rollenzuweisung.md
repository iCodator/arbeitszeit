...
**Geprüftes Dokument:** [`docs/betrieb/rollenzuweisung.md`](../arbeitszeit/docs/betrieb/rollenzuweisung.md) – "Rollenzuweisung und Zugriffsregelung" (Version 1.0, Stand 2026-06-12)
...
**Bewertung:** Systemcheck und Backup sind korrekt durch `require_admin_or_tech` abgesichert und stimmen mit der Zuständigkeitsbeschreibung überein. Die Aussage zu "Restore" ist nicht durch eine im Code vorhandene, rollengeprüfte Funktion belegt; Restore ist laut [`restore_checkliste.md`](../arbeitszeit/docs/betrieb/restore_checkliste.md) ein rein manueller, organisatorisch abzuwickelnder Vorgang außerhalb der Admin-CLI.
...
**Bewertung:** Da es keinen mit einer Rollenprüfung versehenen Restore-Befehl im Code gibt, kann die konkrete rollenbasierte Berechtigungsverteilung ("ADMIN Ja / TECH Ja") technisch nicht verifiziert werden. Die Aussage mag organisatorisch beabsichtigt sein (vgl. [`restore_checkliste.md`, Zeile 29](../arbeitszeit/docs/betrieb/restore_checkliste.md): "Die Rollen/Zuständigkeiten für den Restore sind geklärt (ADMIN/TECH)"), ist aber nicht technisch erzwungen.
