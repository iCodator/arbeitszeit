# Code-Audit arbeitszeit – Stand 2026-07-03 19:54

<!-- meta: generated_at=2026-07-03T17:54:31Z -->
...
- Gesamt-Coverage: **81.6 %** (2244 / 2751 Zeilen)
- Dateien mit Coverage < 60 %:

  | Datei | Coverage |
  |-------|:--------:|
  | `presentation/admin_cli/system.py` | 27 % |
  | `infrastructure/hardware/evdev_reader.py` | 27 % |
...
1. Linting-Fehler beheben (1 Befunde in Ruff-Prüfung).
